    ...
    <div class="row pinkBg blurryImg">
      ...
      <div class="col-md-4 col-sm-12 ShowSecond">
        <div class="paraRight compareSection">
          ...
          <a
            ...
            target="_blank"
            >Customize Now <img src="../assets/images/arrow-right.svg"
          /></a>
        </div>
      </div>
      <div class="col-md-6 col-sm-6 compareImgBlk ShowFirst">
        <div class="compareImg">
          ...
          <div class="imgborder">
            <img src="../assets/images/comparison/c1.png" class="img-fluid" />
          </div>
        </div>
        <div class="compareImg">
          <a href="javascript:" class="btn darkBtn">Ditto Dolls </a>
          <div class="imgborder">
            <img src="../assets/images/comparison/c2.png" class="img-fluid" />
          </div>
        </div>
      </div>
      <div class="col-1"></div>
      ...
      <div class="col-md-6 col-sm-6 compareImgBlk">
        <div class="compareImg">
          ...
          <div class="imgborder detailingImg">
            <img src="../assets/images/comparison/c3.png" class="img-fluid" />
          </div>
        </div>
        <div class="compareImg">
          <a href="javascript:" class="btn darkBtn">Ditto Dolls </a>
    ...
    <div class="row miniatureIntro pinkBg washable">
      ...
      <div class="col-md-6 col-sm-6 compareImgBlk ShowFirst">
        <div class="compareImg">
          <a href="javascript:" class="btn darkBtn">Others </a>
          <div class="imgborder">
            <img src="../assets/images/comparison/c5.png" class="img-fluid" />
          </div>
        </div>
        <div class="compareImg">
          <a href="javascript:" class="btn darkBtn">Ditto Dolls </a>
          <div class="imgborder">
            <img src="../assets/images/comparison/c6.png" class="img-fluid" />
          </div>
        </div>
      </div>
      <div class="col-1"></div>
    ...
    <div class="row miniatureBlurryface whiteBg allposes">
      ...
      <div class="col-md-6 col-sm-6 compareImgBlk">
        <div class="compareImg">
          <a href="javascript:" class="btn darkBtn me-5">Others </a>
          <div class="imgborder">
            <img src="../assets/images/comparison/c7.png" class="img-fluid" />
          </div>
        </div>
        <div class="compareImg ShowThird">
          <a href="javascript:" class="btn darkBtn">Ditto Dolls </a>
          <div class="imgborder">
            <img src="../assets/images/comparison/c8.png" class="img-fluid" />
          </div>
        </div>
      </div>
      <div class="col-md-4 col-sm-12">
    ...
    <div class="row miniatureIntro pinkBg facialExp">
      ...
      <div class="col-md-6 col-sm-6 compareImgBlk ShowFirst">
        <div class="compareImg">
          <a href="javascript:" class="btn darkBtn">Others </a>
          <div class="imgborder">
            <img src="../assets/images/comparison/c9.png" class="img-fluid" />
          </div>
        </div>
        <div class="compareImg">
          <a href="javascript:" class="btn darkBtn">Ditto Dolls </a>
          <div class="imgborder">
            <img src="../assets/images/comparison/c10.png" class="img-fluid" />
          </div>
        </div>
      </div>
      <div class="col-1"></div>
